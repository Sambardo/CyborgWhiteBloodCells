...
namespace ImagineCup
{
    ...
    class BulletPowerup
    {
        ...
        private Bullet power;//keep this private for now
        ...
        /// </summary>
        public BulletPowerup(Level level, Vector2 position, Bullet power)
        {

            this.level = level;
            this.basePosition = position;
            this.power = power;
            this.Color = power.Color;
            LoadContent();
        ...
        {
            collectedSound.Play();
            collectedBy.AddBullet(power);//passing the entire bullet then checking on the players side if they have it isnt perfectly efficient, but it works for now
            //TODO: FREE
        }
